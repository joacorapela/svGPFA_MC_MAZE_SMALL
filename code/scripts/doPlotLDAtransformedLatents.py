...
# 
    ...
    histProj_fig_filename_pattern = \
            "../../figures/{:08d}_histProjectionsLatentsOntoDiscriminatoryDir{:02d}From{:.02f}Duration{:.03f}.{:s}"
    latents_fig_filename_pattern = "../../figures/{:08d}_ldaLatent{:03d}.{{:s}}".format(estResNumber, latent_to_plot)
    ...
    discr_dirs_sl = lda.scalings_
    discr_evals_sl = lda.explained_variance_ratio_
